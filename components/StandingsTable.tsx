...
// Static standings data for seed — cron will overwrite from API
...
export const LA_LIGA_STANDINGS: StandingRow[] = [
    ...
    return (
      <div style={{ textAlign: 'center', padding: 48, color: '#444466' }}>
        <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 12 }}>
          Standings data loads from Firebase after first cron run.
        </p>
      </div>
    )
  }
